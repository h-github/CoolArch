(function() {
    ...
    angular
        .module('coolArch')
        .directive('floorPlanOne', FloorPlan);

    function FloorPlan($document, $mdDialog) {
        return {
            restrict: 'EA',
            // templateUrl: '../app/directives/templates/floorPlanOne.html',
            link: function(scope, el, attrs) {
                ...
                function createRooms(i) {
                    var svgRoom = document.createElementNS(svgNS, "rect"); 
                    svgRoom.setAttributeNS(null, "id", 100 + i);
                    ...
                    svgRoom.setAttributeNS(null, "fill", setBackground(100 + i));
                    ...
                    var textNode = document.createTextNode(100 + i);
                ...
                function createRooms3(i) {
                    var svgRoom = document.createElementNS(svgNS, "rect"); 
                    svgRoom.setAttributeNS(null, "id", 120 + i);
                    ...
                    var textNode = document.createTextNode(120 + i);
                    svgRoomNumber.appendChild(textNode);
                ...
                function createElevators(i) {
                    var svgE = document.createElementNS(svgNS, "rect"); 
