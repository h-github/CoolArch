(function() {
    ...
    angular
    .module('coolArch')
    .directive('floorPlanTwo', FloorPlanTwo);

    function FloorPlanTwo($document, $mdDialog) {
        return {
            restrict: 'EA',
            // templateUrl: '../app/directives/templates/floorPlanTwo.html',
            link: function(scope, el, attrs) {
                
                 var roomStatus = [];
                for(var i=0 ; i<30; i++){
                    roomStatus.push( { roomNumber: 200 + i,
                ...
                function createRooms(i) {
                    ...
                    svgRoom.setAttributeNS(null, "id", 200 + i);
                    ...
                    svgRoom.setAttributeNS(null, "fill", setBackground(200 + i));
                    ...
                    var textNode = document.createTextNode(200 + i);
                ...
                function createRooms3(i) {
                    var svgRoom = document.createElementNS(svgNS, "rect"); //to create a circle. for rectangle use "rectangle"
                    svgRoom.setAttributeNS(null, "id", 220 + i);
                    ...
                    var textNode = document.createTextNode(220 + i);
                    svgRoomNumber.appendChild(textNode);
